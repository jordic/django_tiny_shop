...
class SermepaTest(TestCase):
    ...
    @override_settings(SERMEPA_SECRET_KEY = 'sq7HjrUOBfKmC576ILgskD5srU870gJ7')
    def test_sermepa_response(self):
        ...
        data ={'Ds_AuthorisationCode': u'532895',
                ...
                u'Ds_Card_Country': u'724',
                u'Ds_Terminal': u'001',
                u'Ds_MerchantCode': u'000000000',
                u'Ds_ConsumerLanguage': u'1',
                u'Ds_Response': u'0000',
                u'Ds_Order': u'1825926',
                u'Ds_Currency': u'978',
                u'Ds_Amount': u'25',
                u'Ds_Signature': u'XiMqO66ytDZ8PeoGoiGjm57igv0I4Dr1PD7wXyJLSKE=',
                u'Ds_TransactionType': u'0',
                u'Ds_Hour': u'16:25'}
    ...
    def test_sermepa_form_referencia(self):
        ...
        form = SermepaPaymentForm(merchant_parameters=data)

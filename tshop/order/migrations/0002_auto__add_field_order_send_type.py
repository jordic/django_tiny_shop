...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.send_type'
        db.add_column('order_order', 'send_type',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.send_type'
        db.delete_column('order_order', 'send_type')
    ...
    models = {
        'client.client': {
            ...
            'ship_pc': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
